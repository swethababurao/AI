...
#############################################################################
    ...
    while open_set:
        ...
        children = [(currentNode_row-1, currentNode_col),(currentNode_row+1, currentNode_col), 
                        (currentNode_row, currentNode_col-1),(currentNode_row, currentNode_col+1) ]
...
#############################################################################
    ...
    while open_set:
        ...
        children = [((currentNode_row-1, currentNode_col),v+costFn((currentNode_row-1, currentNode_col))),  ((currentNode_row+1, currentNode_col), v+costFn((currentNode_row+1, currentNode_col))), 
                        ((currentNode_row, currentNode_col-1),v+costFn((currentNode_row, currentNode_col-1))),((currentNode_row, currentNode_col+1),v+costFn((currentNode_row, currentNode_col+1)))]
            
        
        for childNode in children:
            node,cost = childNode 
            node_row, node_col = node
            if (node_row, node_col) not in obstacles and node_row >=0 and node_col >=0 and node_row<n_rows and node_col<n_cols:
                print('Child node is', childNode)
                print('Child row and column is',node_row, node_col)
                ...
                elif childNode in open_set and open_set.get((node_row,node_col)) > cost:
                    open_set.remove(childNode)
                    open_set.put(node,cost)
                    pathTrace[node] = currentNode
                    print('Path Trace loop 1', pathTrace[node])
...
#############################################################################
    ...
    while open_set:
        ...
        children = [((currentNode_row-1, currentNode_col),costG+costFn((currentNode_row-1, currentNode_col))+heuristic(currentNode_row-1, currentNode_col)),    
             ((currentNode_row+1, currentNode_col), costG+costFn((currentNode_row+1, currentNode_col))+heuristic(currentNode_row+1, currentNode_col)), 
             ((currentNode_row, currentNode_col-1),costG+costFn((currentNode_row, currentNode_col-1))+heuristic(currentNode_row, currentNode_col-1)),
             ((currentNode_row, currentNode_col+1),costG+costFn((currentNode_row, currentNode_col+1))+heuristic(currentNode_row, currentNode_col+1))]
